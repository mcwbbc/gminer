...
(function() {
    ...
    if (typeof(window.org['cytoscapeweb']) === 'undefined') { /** @namespace */
    ...
    window.org.cytoscapeweb.Visualization = function(containerId, options) {
        ...
        this.flashAlternateContent = options.flashAlternateContent ? options.flashAlternateContent : 'This content requires the Adobe Flash Player. ' + '<a href=http://www.adobe.com/go/getflash/>Get Flash</a>';
    ...
    org.cytoscapeweb.Visualization.prototype = {
        ...
        ready: function(fn) {
            if (!fn) {
                this._onReady = function() { /*do nothing*/
                };
            } else {
                this._onReady = fn;
            }
        ...
        layout: function( /*layout*/ ) {
            ...
            if (arguments.length > 0) {
                swf.applyLayout(arguments[0]);
                return this;
            } else {
                return swf.getLayout();
            }
        },
        /**
        ...
        visualStyle: function( /*style*/ ) {
            var swf = this.swf();
            if (arguments.length > 0) {
                swf.setVisualStyle(arguments[0]);
                return this;
            } else {
                return swf.getVisualStyle();
            }
        },
        /**
        ...
        panZoomControlVisible: function( /*visible*/ ) {
            var swf = this.swf();
            if (arguments.length > 0) {
                swf.showPanZoomControl(arguments[0]);
                return this;
            } else {
                return swf.isPanZoomControlVisible();
            }
        },
        /**
        ...
        edgesMerged: function( /*merged*/ ) {
            var swf = this.swf();
            if (arguments.length > 0) {
                swf.mergeEdges(arguments[0]);
                return this;
            } else {
                return swf.isEdgesMerged();
            }
        },
        /**
        ...
        nodeLabelsVisible: function( /*visible*/ ) {
            var swf = this.swf();
            if (arguments.length > 0) {
                swf.showNodeLabels(arguments[0]);
                return this;
            } else {
                return swf.isNodeLabelsVisible();
            }
        },
        /**
        ...
        edgeLabelsVisible: function( /*visible*/ ) {
            var swf = this.swf();
            if (arguments.length > 0) {
                swf.showEdgeLabels(arguments[0]);
                return this;
            } else {
                return swf.isEdgeLabelsVisible();
            }
        },
        /**
        ...
        nodeTooltipsEnabled: function( /*enabled*/ ) {
            var swf = this.swf();
            if (arguments.length > 0) {
                swf.enableNodeTooltips(arguments[0]);
                return this;
            } else {
                return swf.isNodeTooltipsEnabled();
            }
        },
        /**
        ...
        edgeTooltipsEnabled: function( /*enabled*/ ) {
            var swf = this.swf();
            if (arguments.length > 0) {
                swf.enableEdgeTooltips(arguments[0]);
                return this;
            } else {
                return swf.isEdgeTooltipsEnabled();
            }
        },
        /**
        ...
        addNode: function(x, y /*, data, updateVisualMappers*/ ) {
            var data, updateVisualMappers = false,
                i = 2;
        ...
        removeElements: function( /*gr, items, updateVisualMappers*/ ) {
            ...
            if (arguments.length >= 1) {
                if (typeof arguments[0] === "string") {
                    gr = arguments[0];
                } else if (this._typeof(arguments[0]) === "array") {
                    items = arguments[0];
                } else if (typeof arguments[0] === "boolean") {
                    updateVisualMappers = arguments[0];
                }
            }
        ...
        addListener: function(evt, /*gr, */ fn) {
            ...
            gr = this._normalizeGroup(gr);
            if (!this._listeners) {
                this._listeners = { /* group: { event: listeners[] } */
                };
            }
            if (!this._listeners[gr]) {
                this._listeners[gr] = {};
            }
        ...
        embedSWF: function() {
            ...
            if (hasProductInstall && !hasRequestedVersion) {
                ...
                AC_FL_RunContent("src", this.flashInstallerPath, "FlashVars", "MMredirectURL=" + MMredirectURL + '&MMplayerType=' + MMPlayerType + '&MMdoctitle=' + MMdoctitle + "", "width", "100%", "height", "100%", "align", "middle", "id", this.id, "quality", "high", "bgcolor", "#ffffff", "name", this.id, "allowScriptAccess", "sameDomain", "type", "application/x-shockwave-flash", "pluginspage", "http://www.adobe.com/go/getflashplayer");
                ...
                AC_FL_RunContent("src", this.swfPath, "width", "100%", "height", "100%", "align", "middle", "id", this.id, "quality", "high", "bgcolor", "#ffffff", "name", this.id, "allowScriptAccess", "always", "type", "application/x-shockwave-flash", "pluginspage", "http://www.adobe.com/go/getflashplayer", "wmode", "opaque", // DO NOT set it to "transparent", because it may crash FireFox and IE on Windows!
                "flashVars", flashVars);
        ...
        _normalizeGroup: function(gr) {
            if (gr) {
                gr = gr.toLowerCase().trim();
            }
            if (gr !== "nodes" && gr !== "edges") {
                gr = "none";
            }
            return gr;
        },
